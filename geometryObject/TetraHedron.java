...
public class TetraHedron extends Solid {
    ...
    public TetraHedron() {
        ...
        getVertexBuffer().add(new Vertex(new Point3D(0, 0, 1), new Col(255, 255, 255)));
        getVertexBuffer().add(new Vertex(new Point3D(1, 0, 0), new Col(255, 255, 255)));
        getVertexBuffer().add(new Vertex(new Point3D(0, 1, 0), new Col(255, 255, 255)));
