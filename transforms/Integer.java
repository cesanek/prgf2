...
public class Integer {
	 ...
	 *            color to be copied
	 */
	public Integer(final Integer c) {
		r = c.r;
		g = c.g;
		b = c.b;
		a = c.a;
	 ...
	 */
	public Integer(final Point3D p) {
		r = p.getX();
		g = p.getY();
		b = p.getZ();
		a = p.getW();
	 ...
	 */
	public Integer(final int argb, final boolean isAlpha) {
		if (isAlpha)
	 ...
	 */
	public Integer(final int r, final int g, final int b) {
		a = 1.0;
		this.r = r / 255.0;
		this.g = g / 255.0;
		this.b = b / 255.0;
	 ...
	 */
	public Integer(final int r, final int g, final int b, final int a) {
		this.a = a / 255.0;
		this.r = r / 255.0;
		this.g = g / 255.0;
		this.b = b / 255.0;
	 ...
	 */
	public Integer(final double r, final double g, final double b) {
		a = 1.0;
		this.r = r;
		this.g = g;
		this.b = b;
	 ...
	 */
	public Integer(final double r, final double g, final double b, final double a) {
		this.a = a;
		this.r = r;
		this.g = g;
		this.b = b;
	 ...
	 */
	public Integer addna(final Integer c) {
		return new Integer(r + c.r, g + c.g, b + c.b);
	}
	 ...
	 * @return new instance of Col
	 */
	public Integer mulna(final double x) {
		return new Integer(r * x, g * x, b * x);
	}
	 ...
	 * @return new instance of Col
	 */
	public Integer add(final Integer c) {
		return new Integer(r + c.r, g + c.g, b + c.b, a + c.a);
	}
	 ...
	 * @return new instance of Col
	 */
	public Integer mul(final double x) {
		return new Integer(r * x, g * x, b * x, a * x);
	}
	 ...
	 * @return new instance of Col
	 */
	public Integer mul(final Integer c) {
		return new Integer(r * c.r, g * c.g, b * c.b, a * c.a);
	}
	 ...
	 * @return new instance of Col
	 */
	public Integer gamma(final double gamma) {
		return new Integer(Math.pow(r, gamma), Math.pow(g, gamma), Math.pow(b,
				gamma), a);
	}
	...
	public Integer saturate() {
		return new Integer(Math.max(0, Math.min(r, 1)),
	...
	public boolean equals(Object obj) {
		return (this == obj) || (obj != null) && (obj instanceof Integer)
				&& (new Double(((Integer) obj).getR()).equals(getR()))
				&& (new Double(((Integer) obj).getG()).equals(getG()))
				&& (new Double(((Integer) obj).getB()).equals(getB()))
				&& (new Double(((Integer) obj).getA()).equals(getA()));
	}
	 ...
	 *         otherwise.
	 */
	public boolean eEquals(Integer integer, double epsilon) {
		return (this == integer) || (integer != null)
				&& Compare.eEquals(getR(), integer.getR(), epsilon)
				&& Compare.eEquals(getG(), integer.getG(), epsilon)
				&& Compare.eEquals(getB(), integer.getB(), epsilon)
				&& Compare.eEquals(getA(), integer.getA(), epsilon);
	}
	 ...
	 *         otherwise.
	 */
	public boolean eEquals(Integer integer) {
		return eEquals(integer, Compare.EPSILON);
	}
